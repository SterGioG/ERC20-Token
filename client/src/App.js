...
state = { loaded: false, kycAddress: "Enter address", tokenSaleAddress: "", userTokens: 0 };
...
listenToTokenTransfer = async() => {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Sterling Token Sale</h1>
        <p>Get your Sterling Token now!</p>
        <h2>Kyc Whitelisting</h2>
        Address to allow: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handleInputChange} />
        <button type="button" onClick={this.handleKycSubmit}>Add address</button>
        <h2>Buy Sterling Tokens</h2>
